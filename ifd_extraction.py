...
# CONFIG
# -----------------------------
KAGGLE_DATASET = "iamsouravbanerjee/indian-food-images-dataset"    # e.g., "ultralytics/yolov5"
ZIP_NAME = "indian-food-images-dataset.zip"                       # kaggle will save here

SAVE_DIR = r"D:\ANNDL\dd"             # where extracted files go
os.makedirs(SAVE_DIR, exist_ok=True)

MAX_IMAGES = 1000   # how many images you want
