...
# CONFIG
# -----------------------------
KAGGLE_DATASET = "mitanshuchakrawarty/new-idd-dataset"    # e.g., "ultralytics/yolov5"
ZIP_NAME = r"D:\ANNDL\new-idd-dataset.zip"                       # kaggle will save here

SAVE_DIR = r"D:\ANNDL\curate"             # where extracted files go
os.makedirs(SAVE_DIR, exist_ok=True)

MAX_IMAGES = 3000   # how many images you want
